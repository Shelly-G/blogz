...
def login():
    ...
    if request.method == 'POST':
        ...
        if not user:
            username_error = "Sorry, you do not exist."
            if username == "":
        ...
        if user and user.password != password:
            password_error = "That is the wrong password. Ugh!"
    ...
    if request.method == "POST":
        ...
        if not username_error and not password_error and not verify_error:
            if not existing_user:
                ...
                username_error = "Sorry! Username is already claimed. Try again."
...
def create_new_post():
    ...
    if request.method == 'POST':
        ...
        if blog_title == "":
            title_error = "You forgot something. Please enter a title!"

        if blog_content == "":
            content_error = "Seriously??! You don't have anything to say? Please enter a post!"
